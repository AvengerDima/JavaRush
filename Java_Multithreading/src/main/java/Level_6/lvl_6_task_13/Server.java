...
public class Server {
    ...
    private static class Handler extends Thread { //Обработчик
        ...
        private String serverHandshake(Connection connection) throws IOException, ClassNotFoundException { //Рукопожатие с сервером
            while (true) {
        ...
        private void notifyUsers(Connection connection, String userName) throws IOException { //Уведомление пользователей
        ...
        private void serverMainLoop(Connection connection, String userName) throws IOException, ClassNotFoundException { //Главная петля сервера
            while (true) {
                Message message = connection.receive();
