...
public class Model { //Содержание игровой логики и хранение игрового поля
    ...
    public void resetGameTiles() {
        ...
        for (int i = 0; i < FIELD_WIDTH; i++) { //заполняем игровое поле пустыми плитками
    ...
    private void addTile() {
        ...
        if (!emptyTiles.isEmpty()) {
            int index = (int) (emptyTiles.size() * Math.random() % emptyTiles.size());
